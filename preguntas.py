...
def pregunta_03():
    ...
    pipeline = Pipeline(
        steps=[
            ...
            (
                "mlpregressor",
                MLPRegressor(activation='relu',max_iter=5000,early_stopping=True),  
            ),
        ],
    )
...
def pregunta_04():
    ...
    param_grid = {
        'mlpregressor__hidden_layer_sizes': [1,2,3,4,5,6,7,8,9],  
        'mlpregressor__momentum': [0.6,0.7,0.8,0.9],  
